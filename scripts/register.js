...
function register(){
    ...
    console.log(inputFirstName,inputLastName,inputAge,inputGender,inputPhone,inputPayment,inputColor);
...
// //jquery
// $("#txtAge").hide();
// So these are the same, first is jquery and second is js:
